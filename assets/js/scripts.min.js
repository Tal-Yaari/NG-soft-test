...
!function(i){i(".submit-btn").on("click",function(){i(".update-form").addClass("sent"),i(".email-sent").addClass("message")}),i(document).ready(function(){i(".banner-carousel").slick({infinite:!0,arrows:!1,autoplay:!0,adaptiveHeight:!0,slidesToShow:1,slidesToScroll:1,autoplaySpeed:4e3,rtl:!0,speed:1e3,cssEase:"cubic-bezier(0.7, 0, 0.3, 1)",touchThreshold:100})});i(".banner-carousel .slick-active").find("iframe").get(0).play();i("banner-carousel").on("afterChange",function(e,a,n,s){i(".banner-carousel .slick-slide").find("video").get(0).pause();i(".banner-carousel .slick-active").find("video").get(0).play()})}(jQuery);