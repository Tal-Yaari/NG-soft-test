...
!function(l){l(document).ready(function(){l(".banner-carousel").slick({infinite:!0,arrows:!1,autoplay:!0,adaptiveHeight:!0,slidesToShow:1,slidesToScroll:1,autoplaySpeed:4e3,rtl:!0})});l(".banner-carousel .slick-active").find("iframe").get(0).play();l("banner-carousel").on("afterChange",function(e,a,n,i){l(".banner-carousel .slick-slide").find("video").get(0).pause();l(".banner-carousel .slick-active").find("video").get(0).play()})}(jQuery);